...
public class array_list {
    public static void main(String[] args) {
        ...
        System.out.println(l1.indexOf(101));                            // Returns the index of the first occurence of theelement

        l1.add(4, 101);

        System.out.println(l1.lastIndexOf(101));                        // Returns the index of the last occurence of the element
